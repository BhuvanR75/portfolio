...
const About: React.FC = () => {
  ...
  return (
    <section id="about" className="relative w-full bg-[#fcf4ee] text-black py-32 overflow-hidden border-t border-white/5">
        
        {/* Decor */}
        <div className="absolute top-12 left-12 opacity-75"><Crosshair className="text-[#5862ec] w-8 h-8" /></div>
        <div className="absolute bottom-12 right-12 opacity-20"><Crosshair className="text-[#5862ec] w-8 h-8" /></div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="order-2 lg:order-1">
                    <h2 className="text-4xl md:text-6xl font-black uppercase mb-8 leading-[0.9]">
                        Crafting <span className="text-[#5862ec]">Visual</span> <br/> Impact
                    </h2>
                    ...
                    <div className="grid grid-cols-2 gap-8">
                        <div>
                            <div className="flex items-center gap-2 mb-2 text-[#5862ec]">
                                <Zap size={20} />
                ...
                >
                    ...
                    <div className="absolute bottom-0 w-full h-1/3 bg-gradient-to-t from-[#fcf4ee] to-transparent"></div>
                </motion.div>
