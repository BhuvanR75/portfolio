        ...
        <div className="border-b border-black/10">
            ...
            >
                <div className="flex items-baseline gap-4 md:gap-12 w-full md:w-1/2">
                    <span className="text-sm font-mono text-[#5862ec]">0{exhibition.id}</span>
                    <h3 className="text-2xl md:text-3xl font-bold font-['Syne'] text-black group-hover:ml-4 transition-all duration-300">
                        {exhibition.title}
                    </h3>
                </div>
                    ...
                    >
                        <div className="p-8 md:p-12 border-t border-dashed border-white/10">
                             <div className="flex flex-col justify-center max-w-3xl">
                                 <h4 className="text-lg font-bold mb-4 text-[#5862ec">Role Overview</h4>
                                 ...
                                 <div className="flex gap-4">
                                     {!aiDescription && (
                                         <button 
                                            ...
                                            disabled={loading}
                                            className="flex items-center gap-2 text-sm font-bold uppercase tracking-wide text-white hover:text-[#5862ec] transition-colors"
                                         >
                                             {loading ? (
...
const Exhibitions: React.FC = () => {
  ...
  return (
    <section id="exhibitions" className="py-24 bg-[#fcf4ee] border-t border-white/5">
        <div className="container mx-auto px-4 md:px-12">
            <h2 className="text-4xl md:text-6xl font-black uppercase text-black mb-16 tracking-tighter">
                Experience
            </h2>
